<template>
  <article class="article content section-article mx-auto">
    ...
    <v-container class="d-flex flex-column align-start blog-content pa-0">
      <v-img width="100%" :minHeight="`200px`" class="mb-9 mx-auto" :src="bannerPath(article)" />
      <div style="width: 100%;" class="d-flex flex-row justify-space-between align-center mb-9">
